...
// main.html 에서 받은 이미지 파일을 클라이언트의 요청에 맞게 reSize 혹은 grayScale 적용 후 클라이언트 로컬에 다시 저장하고 변경된
//이미지의 모습을 out.print 로 보여준다.
// editImage메소드가 요청한 정보를 매게변수로 받아서 사진을 편집해준다.
